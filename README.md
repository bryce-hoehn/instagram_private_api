...
``pip install git+https://git@github.com/bryce-hoehn/instagram_private_api.git@1.6.0``

To update:

``pip install git+https://git@github.com/bryce-hoehn/instagram_private_api.git@1.6.0 --upgrade``

To update with latest repo code:

``pip install git+https://git@github.com/bryce-hoehn/instagram_private_api.git --upgrade --force-reinstall``
